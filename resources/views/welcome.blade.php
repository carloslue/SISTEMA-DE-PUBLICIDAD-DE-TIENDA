...
<body class="antialiased">
    <div class="panel relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                <a class="nav-link" href="{{ URL::to('productosC') }}">{{ __('PRODUCTOS QUE OFRECEMOS') }}</a>
